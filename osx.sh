...
sudo scutil --set ComputerName "Giant"
sudo scutil --set HostName "Giant"
sudo scutil --set LocalHostName "Giant"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Giant"
